...
@Entity
public class SpeedAndActivityTest4 {
    @Id
    ...
    public SpeedAndActivityTest4() {
    }

    public SpeedAndActivityTest4( String variatorSpeed, double chronoSpeed, double gap, boolean compliant) {
