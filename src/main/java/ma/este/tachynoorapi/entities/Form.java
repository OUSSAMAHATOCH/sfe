...
public class Form {
    ...
    @OneToOne(cascade = CascadeType.ALL)
    private VerificationNormalConditions verificationNormalConditions;


    public Form() {}

    public Form(Date date, Client client, Vehicle vehicle, NormalConditions normalConditions, AdaptationCoeff adaptationCoeff, Test1000m test1000m, Instrument instrument, ClockTest clockTest, Technician technician, TestDistance testDistance ,VerificationNormalConditions verificationNormalConditions,OrderService orderService,int fileNumber,SpeedAndActivityTest1 speedAndActivityTest1,SpeedAndActivityTest2 speedAndActivityTest2,SpeedAndActivityTest3 speedAndActivityTest3,SpeedAndActivityTest4 speedAndActivityTest4,SpeedAndActivityTest5 speedAndActivityTest5 , SpeedAndActivityTest6 speedAndActivityTest6,SpeedAndActivityTest7 speedAndActivityTest7) {
        this.date = date;
        this.client = client;
        ...
        this.verificationNormalConditions = verificationNormalConditions;
    ...
    public VerificationNormalConditions getVerificationNormalConditions() {
        return verificationNormalConditions;
    }

    public void setVerificationNormalConditions(VerificationNormalConditions verificationNormalConditions) {
        this.verificationNormalConditions = verificationNormalConditions;
    }
    ...
    public String toString() {
        return "Form{" +
                ...
                ", verificationNormalConditions=" + verificationNormalConditions +
                '}';
    }
}
